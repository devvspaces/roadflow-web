...
export default function Roles() {
  ...
  return (
    <>
      <Head>
        <title>RoadflowAI - Welcome</title>
      </Head>
      ...
      <Container maxW={"5xl"}>
        <Stack as={Box} textAlign={"center"} spacing={{ base: 8 }} py={20}>
          ...
          <Text color={"gray.500"}>
            To get started, select a job role that you are interested in. If you
            are already familiar with a job role, you can skip this step. If you
            are not sure yet what you want to do, you can always change it
            later.
          </Text>
          ...
          <HStack gap={4} spacing={0} wrap={"wrap"} justify={"center"}>
            ...
            <Select
              ...
              h={14}
              borderRadius={30}
              placeholder="Salary average by country"
              id="salary-avg-by-country"
            >
