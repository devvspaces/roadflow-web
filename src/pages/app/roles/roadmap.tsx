...
export default function RoleRoadMap() {
  ...
  return (
    <>
      <Head>
        <title>RoadflowAI - Roadmap (Data Engineer)</title>
      </Head>
      ...
      <Container maxW={"5xl"}>
        ...
        >
          ...
          <Text maxW={"3xl"} color={"gray.500"}>
            This is a roadmap for becoming a Data Engineer. Don&apos;t feel
            overwhelmed, you don&apos;t need to know it all to start working.
            Just pick a path and start learning!
          </Text>
        </Stack>
          ...
          >
            ...
            >
              ...
              <Text>
                ...
                Accusamus quisquam asperiores et veritatis culpa cumque eum
                dolor provident.
              </Text>
            </Box>
